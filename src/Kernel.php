...
class Kernel
{
    ...
    public function __construct(array $config)
    {
        ...
        $dbDsn = $this->configManager->get('APP_DB_DSN');
        $dbUser = $this->configManager->get('APP_DB_USER');
        $dbPass = $this->configManager->get('APP_DB_PASS');
        $database = new Database($dbDsn, $dbUser, $dbPass);
